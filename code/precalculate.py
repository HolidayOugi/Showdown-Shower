...
def battle():
    ...
    for format in formats:
        ...
        df_path = f'../output/tiers/{format}.csv'
        if os.path.exists(df_path):
            format_df = pd.read_csv(df_path)

        else:
            pattern = glob.escape(f'../output/tiers/{format}') + "_*.csv"
...
def players():
    ...
    for format in formats:
        ...
        players_df = pd.read_csv(f'../output/players/{format}_players.csv')
        ...
        pio.write_json(fig, f'../graphs/players/{format}/fig1.json')
        ...
        pio.write_json(fig, f'../graphs/players/{format}/fig2.json')
        ...
        pio.write_json(fig, f'../graphs/players/{format}/fig3.json')
        ...
        pio.write_json(fig, f'../graphs/players/{format}/fig4.json')

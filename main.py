...
with st.expander("About this project"):
    ...
    st.markdown("This website contains the results of over 550k competitive battle replays from Pokémon Showdown or other earlier simulators, ranging from 2005 to 2025. These replays are divided by generation and format. A replay may also have a rating, which shows the skill level of the two players, starting from 1000 for a new player.")
